                        ...
                        <div className="p-4 border-t border-slate-200 dark:border-slate-800">
                            {isSidebarCollapsed ? (
                                <div
                                    ...
                                    className="w-full bg-slate-100 dark:bg-slate-800/50 rounded-lg p-3 flex flex-col items-center gap-2 cursor-pointer hover:bg-slate-200 dark:hover:bg-slate-800 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
                                    role="button"
                                    tabIndex={0}
                                    aria-label="Open Settings"
                                >
                                ...
                                <div
                                    ...
                                    className="w-full bg-slate-100 dark:bg-slate-800/50 rounded-lg p-3 text-xs space-y-2 cursor-pointer hover:bg-slate-200 dark:hover:bg-slate-800 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900 text-left"
                                    role="button"
                                    tabIndex={0}
                                    aria-label="Open Settings"
                                >
