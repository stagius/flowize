                                                ...
                                                {assignedTask.status === TaskStatus.WORKTREE_ACTIVE && (
                                                    <>
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex items-center justify-center gap-1.5 bg-emerald-600 hover:bg-emerald-500 text-white px-3 py-1.5 rounded-lg text-xs font-medium transition-colors shadow-lg shadow-emerald-900/20"
